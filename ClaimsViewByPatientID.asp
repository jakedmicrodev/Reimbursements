...
If patientID <> "" Then
	view=manager.ViewClaimsByPatientID(patientID)
Else
	view=""
End If
...
<html>
	<head>
		...
		<title>View Claims By Patient</title>
	...
	<body>
		<div class="container">
			<h2>Claims By Patient</h2>
			<form  action="ClaimsViewByPatientID.asp" method="post" name="form">
				<div class="row">
					<div class="col-10">

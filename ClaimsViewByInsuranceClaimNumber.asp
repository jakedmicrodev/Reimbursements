...
If claimNumber <> "" Then
	view=manager.ViewClaimsByInsuranceClaimNumber(claimNumber)
End If
...
<html>
	...
	<body>
		<div class="container">
			<h2>Claims By Insurance Claim Number</h2>
			<form  action="ClaimsViewByInsuranceClaimNumber.asp" method="post" name="form">
				<div class="row">
					<div class="col-15">
						<label for="ClaimNumber">Insurance Claim Number</label>
					</div>
					<div class="col-10">
						<%= claimNumberList %>
					</div>

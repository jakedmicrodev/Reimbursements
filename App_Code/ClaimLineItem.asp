...
Class CClaim
    Private mLineItemID
	Private mClaimID
	Private mDateOfService
	Private mService
	Private mAmoutChargedByProvider
	Private mAmountNotCovered
	Private mRegenceMemberRate
	Private mCopay
	Private mDeductible
	Private mRemainingAmount
	Private mMemberCoinsurance
	Private mAmountRegencePaid
	Private mMemberResponsibilityToProvider
	...
	Private Sub Class_Initialize()
        ...
        mAmoutChargedByProvider = 0
        mAmountNotCovered = 0
        mRegenceMemberRate = 0
        mCopay = 0
        mDeductible = 0
        mRemainingAmount = 0
        mMemberCoinsurance = 0
        mAmountRegencePaid = 0
        mMemberResponsibilityToProvider = 0
		mMedicationAmount = 0
